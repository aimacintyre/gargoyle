...
ovpnS.CertSt="Certificate Status";
ovpnS.SrvCertExp="Server Certificate Expiry";
ovpnS.CrlExp="Certificate Revocation List (CRL) Expiry";
ovpnS.RenewCrl="Renew CRL";
ovpnS.CrlRenewC="This will regenerate the Certificate Revocation List (CRL). Continue?";
ovpnS.NotConf="Not Configured";
...
ovpnS.CfgFOvpn="Single Configuration File (.ovpn)";
ovpnS.ZipF="Zip File";
...
ovpnS.UseAUP="Use Auth User/Pass";
ovpnS.AUPUser="Username";
ovpnS.AUPPass="Password";
ovpnS.rvel="reveal";
...
ovpnS.PrefVPNGtwy="Client prefers <i>vpn_gateway</i>";
...
ovpnS.CfgCredFM="Credentials\n&amp; Config Files\n(Multiple)";
ovpnS.CfgCredFS="Credentials\n&amp; Config Files\n(Single .ovpn)";
...
ovpnS.DescNOVPNT="If you want all traffic to pass through the VPN, it is best to block all non-OpenVPN traffic so that if OpenVPN fails traffic will not fallback to the default, unencrypted route. However if you are using OpenVPN only to access some remote clients you should allow Non-OpenVPN traffic.";
